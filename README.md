...
<h2  align="left" height="200">I used to 🎻 all the time, now I 
...
<ul>
  ...
  <li>Built with Next.js / TypeScript frontend and a PHP backend, CI/CD via GitHub Actions and SMTP without tracking via MailPace</li>
</ul>
</div>
